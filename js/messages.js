var messages = {
  ...
  title: {
    'en': 'IT RUN Froggy - A game for learning CSS flexbox',
    'he': 'IT RUN Froggy - משחק ללמידת CSS flexbox',
    'ro': 'IT RUN Froggy - Un joc pentru a învăța CSS flexbox',
    'sr': 'IT RUN Froggy - Игра за учење CSS flexbox-а',
    'bs': 'IT RUN Froggy - Igra za učenje CSS flexbox-a',
    'hr': 'IT RUN Froggy - Igra za učenje CSS flexboxa',
    'bg': 'IT RUN Froggy - Игра за учене на CSS flexbox',
    'de': 'IT RUN Froggy - Ein Spiel, um CSS flexbox zu lernen',
    'fr': 'IT RUN Froggy - Un jeu pour apprendre les flexbox CSS',
    'pt-br': 'IT RUN Froggy - Um jogo para aprender CSS flexbox',
    'es': 'IT RUN Froggy - Un juego para aprender CSS flexbox',
    'ru': 'IT RUN Froggy - игра для изучения CSS flexbox',
    'fa': 'قورباغه فلکس باکس - یک بازی جذاب برای آموزش سی اس اس فلکس باکس',
    'zh-cn': 'IT RUN Froggy - 一个用来学CSS flexbox的游戏',
    'zh-tw': 'IT RUN Froggy - 一個用來學CSS flexbox的遊戲',
    'tr': 'IT RUN Froggy - CSS flexbox için öğretici oyun',
    'az': 'IT RUN Froggy - CSS flexbox üçün öyrədici oyun',
    'it': 'IT RUN Froggy - Un gioco per imparare CSS flexbox',
    'ko': 'IT RUN Froggy - CSS flexbox 속성 배우기 게임',
    'lt': 'IT RUN Froggy - Žaidimas padėsiantis perprasti CSS "flexbox" metodiką',
    'vi': 'IT RUN Froggy - Một trò chơi để học CSS flexbox',
    'pl': 'IT RUN Froggy - Gra wprowadzająca do CSS flexbox"',
    'cs': 'IT RUN Froggy - CSS flexbox hrou',
    'ja': 'IT RUN Froggy - CSS flexbox学習ゲーム',
    'hu': 'IT RUN Froggy - Játékos CSS flexbox tanulás',
    'eo': 'IT RUN Froggy - Ludo por lerni CSS flexbox-on',
    'sv': 'IT RUN Froggy - Ett spel för att lära sig CSS flexbox',
    'uk': 'IT RUN Froggy - гра для вивчення CSS flexbox',
    'hi': 'IT RUN Froggy - CSS Flexbox सीखने के लिए एक खेल',
    'gj': 'IT RUN Froggy - CSS Flexbox  શીખવા માટેની એક રમત',
    'nl': 'IT RUN Froggy - Een spel om CSS flexbox te leren',
    'ta': 'IT RUN Froggy - CSS flexbox கற்றல் விளையாட்டு',
    'te': 'IT RUN Froggy - CSS Flexbox నేర్చుకోవడానికి ఒక ఆట',
    'ml': 'IT RUN Froggy - CSS Flexbox പഠിക്കാം',
    'el': 'IT RUN Froggy - Ένα παιχνίδι για την εκμάθηση του CSS Flexbox',
    'mk': 'IT RUN Froggy - Игра за учење на CSS flexbox',
    'lv': 'IT RUN Froggy - Spēle, kas Tev palīdzēs iemācīties CSS Flexbox',
    'id': 'IT RUN Froggy - Sebuah permainan untuk belajar CSS flexbox',
    'ar': 'فروغي فلكسبكس - لعبة لتعلم الفلكسبكس في CSS',
    'ca': 'IT RUN Froggy - Un joc per aprendre CSS Flexbox',
    'da': 'IT RUN Froggy - Et spil, der lærer dig CSS Flexbox',
    'et': 'IT RUN Froggy - Mäng CSS flexbox\'i õppimiseks',
    'fi': 'IT RUN Froggy - Peli, jossa opit CSS flexbox -asettelun',
    'gl': 'IT RUN Froggy - Un xogo para aprenderes CSS Flexbox',
    'th': 'IT RUN Froggy - เกมสำหรับเรียนรู้ CSS Flexbox',
    'mn': 'IT RUN Froggy - CSS flexbox-г сурах тоглоом',
    'sk': 'IT RUN Froggy - Hra na učenie CSS flexbox',
    'si': 'IT RUN මැඬියා - CSS flexbox ඉගෙනීමේ ක්‍රීඩාවක්',
    'bn': 'IT RUN Froggy - CSS flexbox শেখার জন্য একটি খেলা',
  },
  labelReset: {
    'en': 'Reset',
    'he': 'איפוס',
